package com.journeyOS.data.source.local.city;
...
public interface CityDao {
    ...
    @Query("SELECT * FROM " + DBConfigs.City.TABLE_NAME + " WHERE " + DBConfigs.City.CITY_NAME + " LIKE  :key " +
            "|| '%' OR " + DBConfigs.City.ADM1 + " LIKE  :key " +
            "|| '%' OR " + DBConfigs.City.ADM2 + " LIKE  :key || '%' ")
