...
public class PullRefreshLayout extends ViewGroup {
    ...
    private com.journeyOS.liteweather.view.PullRefreshLayout.OnRefreshListener mListener;
    ...
    public PullRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        final int type = STYLE_SMARTISAN;
        final int colorsId = 0;
        final int colorId = 0;
//        a.recycle();
        ...
        if (colorsId > 0) {
            ...
            mColorSchemeColors = new int[]{Color.rgb(0xC9, 0x34, 0x37)/*红*/,
                    Color.rgb(0x37, 0x5B, 0xF1)/*蓝*/,
                    Color.rgb(0xF7, 0xD2, 0x3E)/*黄*/,
                    Color.rgb(0x34, 0xA3, 0x50)/*绿*/};
        }
    ...
    public void setOnRefreshListener(com.journeyOS.liteweather.view.PullRefreshLayout.OnRefreshListener listener) {
        mListener = listener;
    }
