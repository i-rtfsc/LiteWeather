...
import static com.journeyOS.widget.sky.CloudySky.CircleHolder;

/**
 * 雾
 */
public class FogSky extends BaseSky {
    private Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
    final ArrayList<CircleHolder> holders = new ArrayList<CircleHolder>();

    public FogSky(Context context, boolean isNight) {
    ...
    protected int[] getSkyBackgroundGradient() {
        return isNight ? ResourceSky.SkyBackground.FOG_N : ResourceSky.SkyBackground.FOG_D;
    }
}
