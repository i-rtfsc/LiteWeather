...
public class SandSky extends BaseSky {
    ...
    public SandSky(Context context, boolean isNight) {
    ...
    public static class ArcHolder {
        ...
        public ArcHolder(float cx, float cy, float radiusWidth, float radiusHeight, float strokeWidth, float fromDegree, float endDegree,
            ...
            this.stepDegree = SkyUilts.getRandom(0.4f, 0.8f);
        }
    ...
    protected int[] getSkyBackgroundGradient() {
        return isNight ? ResourceSky.SkyBackground.SAND_N : ResourceSky.SkyBackground.SAND_D;
    }
}
